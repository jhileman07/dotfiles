...
function R(name)
  ...
  if ok then reload.reload_module(name) end
  return require(name)
end
...
autocmd("BufWritePre", {
  ...
  callback = function(args)
    ...
    if ft == "markdown" or ft == "gitcommit" then return end
...
autocmd("FileType", {
  group = MyGroup,
  pattern = "zig",
  callback = function() pcall(vim.cmd.colorscheme, "tokyonight-night") end,
})
autocmd("FileType", {
  group = MyGroup,
  pattern = "*",
  callback = function() pcall(vim.cmd.colorscheme, "rose-pine-moon") end,
})
